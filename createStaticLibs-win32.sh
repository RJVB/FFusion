...
configureflags="--disable-doc --enable-pthreads --disable-w32threads --enable-runtime-cpudetect \
	...
	--enable-ffprobe --enable-ffmpeg --enable-shared --disable-static --disable-stripping"
