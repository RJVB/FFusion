...
extern DLLIMPORT const uint8_t ff_golomb_vlc_len[512];
extern DLLIMPORT const uint8_t ff_ue_golomb_vlc_code[512];
extern DLLIMPORT const  int8_t ff_se_golomb_vlc_code[512];
extern DLLIMPORT const uint8_t ff_ue_golomb_len[256];

extern DLLIMPORT const uint8_t ff_interleaved_golomb_vlc_len[256];
extern DLLIMPORT const uint8_t ff_interleaved_ue_golomb_vlc_code[256];
extern DLLIMPORT const  int8_t ff_interleaved_se_golomb_vlc_code[256];
extern DLLIMPORT const uint8_t ff_interleaved_dirac_golomb_vlc_code[256];
