...
#define FFMPEG_CONFIGURATION "--extra-ldflags='-march=core2 -g -msse2 -msse3 -mssse3 -msse4 -arch i386 -Dattribute_deprecated= -w' --extra-cflags='-march=core2 -g -msse2 -msse3 -mssse3 -msse4 -arch i386 -Dattribute_deprecated= -w -fweb -ftree-vectorize -ftracer -O3 -fexpensive-optimizations -finline-functions -funroll-loops -fstrict-aliasing -finline-limit=1000 -freorder-blocks --param max-completely-peel-times=2' --prefix=/Volumes/Debian/Users/bertin/work/src/MacOSX/FFusion-124R/FFmpeg/win32 --disable-doc --disable-pthreads --enable-w32threads --enable-runtime-cpudetect --disable-encoders --disable-ffprobe --disable-ffserver --disable-muxers --disable-network --disable-avdevice --disable-swscale --enable-avfilter --target-os=mingw32 --enable-memalign-hack --arch=x86 --enable-libopenjpeg --extra-cflags=-I/Volumes/Debian/Users/bertin/work/src/MacOSX/FFusion-124R/FFmpeg/win32/include/openjpeg-1.5 --extra-ldflags=-L/Volumes/Debian/Users/bertin/work/src/MacOSX/FFusion-124R/FFmpeg/win32/lib --enable-cross-compile --cross-prefix=/Developer/Cocotron/1.0/Windows/i386/gcc-4.3.1/bin/i386-mingw32msvc- --enable-ffprobe --enable-shared --disable-static --disable-stripping"
