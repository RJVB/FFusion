...
#define FFMPEG_CONFIGURATION "--extra-ldflags='-mmacosx-version-min=10.6 -D__DARWIN_UNIX03=0 -Dattribute_deprecated= -w -msse3 -msse4 -mssse3 -arch i386' --cpu=core2 --extra-cflags='-arch i386 -mmacosx-version-min=10.6 -D__DARWIN_UNIX03=0 -Dattribute_deprecated= -w -msse3 -msse4 -mssse3 -fweb -fstrict-aliasing -finline-limit=1000 -freorder-blocks -O3 -finline-functions -funroll-loops -fno-tree-vectorize -ftracer -mdynamic-no-pic -mtune=core2 --param max-completely-peel-times=2' --prefix=/Volumes/Debian/Users/bertin/work/src/MacOSX/FFusion-124R/FFmpeg/osx86 --cc=gcc-mp-4.7 --disable-amd3dnow --disable-doc --enable-encoders --enable-ffprobe --disable-ffserver --enable-muxers --disable-network --enable-libopenjpeg --extra-cflags=-I/opt/local/include --extra-ldflags=-L/opt/local/lib --enable-swscale --enable-avfilter --disable-avdevice --enable-ffmpeg --disable-ffplay --target-os=darwin"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define FFMPEG_DATADIR "/Volumes/Debian/Users/bertin/work/src/MacOSX/FFusion-124R/FFmpeg/osx86/share/ffmpeg"
#define CC_TYPE "gcc"
