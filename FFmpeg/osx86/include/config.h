...
#define FFMPEG_CONFIGURATION "--extra-ldflags='-isysroot /Developer/SDKs/MacOSX10.5.sdk -mmacosx-version-min=10.4 -D__DARWIN_UNIX03=0 -Dattribute_deprecated= -w -msse3 -msse4 -mssse3 -arch i386' --cpu=core2 --extra-cflags='-arch i386 -isysroot /Developer/SDKs/MacOSX10.5.sdk -mmacosx-version-min=10.4 -D__DARWIN_UNIX03=0 -Dattribute_deprecated= -w -msse3 -msse4 -mssse3 -fweb -fstrict-aliasing -finline-limit=1000 -freorder-blocks -O3 -finline-functions -funroll-loops -ftree-vectorize -ftracer -mdynamic-no-pic -mtune=core2 --param max-completely-peel-times=2' --cc=/Developer/usr/bin/gcc-4.2 --disable-amd3dnow --disable-doc --disable-encoders --disable-ffprobe --disable-ffserver --disable-muxers --disable-network --disable-swscale --disable-avfilter --target-os=darwin"
